...
async function main() {
  ...
  await client
    ...
    .set({
      ...
      'projects.intro': lt(site.projects.intro, 'A short selection of projects that show technical judgement, product thinking, performance and real integrations.'),
      ...
      'contact.formModalSubmitLabel': ls(site.contact.formModalSubmitLabel, en.contact.formModalSubmitLabel),
      'contact.formModalPrivacyLabel': ls(site.contact.formModalPrivacyLabel, en.contact.formModalPrivacyLabel),
      'contact.formModalSuccessMessage': ls(site.contact.formModalSuccessMessage, en.contact.formModalSuccessMessage),
      ...
      'careerModal.pdfIframeTitle': ls(site.careerModal.pdfIframeTitle, en.careerModal.pdfIframeTitle),
