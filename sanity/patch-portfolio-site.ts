...
const asLocaleString = (value?: string, en?: string): LocaleString => ({ es: value || '', en: en || '' });
const asLocaleText = (value?: string, en?: string): LocaleText => ({ es: value || '', en: en || '' });
...
function mapPortfolioDocument() {
  ...
  return {
    ...
    projects: {
      ...
      archiveLinkLabel: asLocaleString(site.projects.archiveLinkLabel, en.projects.archiveLinkLabel),
    ...
    contact: {
      ...
      formModalSubmitLabel: asLocaleString(site.contact.formModalSubmitLabel, en.contact.formModalSubmitLabel),
      formModalPrivacyLabel: asLocaleString(site.contact.formModalPrivacyLabel, en.contact.formModalPrivacyLabel),
