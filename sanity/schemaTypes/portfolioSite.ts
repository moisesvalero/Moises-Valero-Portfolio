...
export const portfolioSite = defineType({
	...
	fields: [
		...
		defineField({
			...
			fields: [
				...
				defineField({
					name: 'ogImage',
					type: 'string',
					title: 'OG image (URL absoluta o ruta /og-image-2026.png)',
					description:
						'Archivo recomendado en el sitio: /og-image-2026.png (sube la imagen a /static/og-image-2026.png). Si es relativa, se antepondrá PUBLIC_SITE_URL.',
					initialValue: '/og-image-2026.png'
				}),
				{
					name: 'twitterCard',
					type: 'string',
		...
		defineField({
			...
			title: 'Competencias',
			description:
				'Solo controla la etiqueta superior del bloque. El contenido visible se define en la web.',
			group: 'servicios',
			fields: [
				{
					name: 'meta',
		...
		defineField({
			...
			fields: [
				...
				{
					name: 'formModalSubmitLabel',
					type: 'localeString',
					title: 'Texto botón enviar formulario'
				},
				{
					name: 'formModalPrivacyLabel',
					type: 'localeString',
					title: 'Texto privacidad formulario'
				},
				{
		...
		defineField({
			...
			fields: [
				...
				{ name: 'youtubeHref', type: 'url', title: 'YouTube' },
