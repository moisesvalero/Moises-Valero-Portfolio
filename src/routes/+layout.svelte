<script lang="ts">
	...
	const xDefaultHref = $derived(
		(data as LayoutData & { xDefaultHref?: string }).xDefaultHref ?? data.canonicalUrl
	);
...
<svelte:head>
	...
	<link rel="alternate" type="text/plain" title="llms.txt" href={resolve('/llms.txt')} />
	<link rel="alternate" type="text/plain" title="llms-full.txt" href={resolve('/llms-full.txt')} />
	...
	<header class="motion-header" class:menu-open={menuOpen}>
		<div class="motion-header-shell">
			<div class="motion-header-bar">
				...
				<div
					class="motion-header-actions"
					aria-label={data.locale === 'en' ? 'Social links' : 'Redes sociales'}
				>
					<button
					...
					>
						{#if colorTheme === 'dark'}
							<svg viewBox="0 0 24 24" aria-hidden="true">
								<path
									d="M12 4.4a1 1 0 0 0 1-1V2a1 1 0 1 0-2 0v1.4a1 1 0 0 0 1 1Zm0 15.2a1 1 0 0 0-1 1V22a1 1 0 1 0 2 0v-1.4a1 1 0 0 0-1-1ZM4.4 12a1 1 0 0 0-1-1H2a1 1 0 1 0 0 2h1.4a1 1 0 0 0 1-1Zm17.6-1h-1.4a1 1 0 1 0 0 2H22a1 1 0 1 0 0-2ZM5.22 3.8A1 1 0 0 0 3.8 5.22l1 1A1 1 0 0 0 6.22 4.8l-1-1Zm13.96 13.96a1 1 0 0 0-1.42 1.42l1.02 1.02a1 1 0 0 0 1.42-1.42l-1.02-1.02ZM20.2 5.22a1 1 0 0 0-1.42-1.42L17.76 4.8a1 1 0 0 0 1.42 1.42l1.02-1ZM6.22 19.18a1 1 0 1 0-1.42-1.42L3.8 18.78a1 1 0 1 0 1.42 1.42l1-1.02ZM12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z"
								/>
							</svg>
						{:else}
							<svg viewBox="0 0 24 24" aria-hidden="true">
								<path
									d="M21.5 14.4a8.3 8.3 0 0 1-11.9-10 1 1 0 0 0-1.05-1.32 9.7 9.7 0 1 0 12.36 12.36 1 1 0 0 0-1.32-1.05Z"
								/>
							</svg>
						{/if}
					</button>
			...
			{#if menuOpen}
				<nav
					class="motion-menu-panel"
					aria-label={data.locale === 'en' ? 'Main menu' : 'Menu principal'}
				>
...
<style>
	...
	.motion-menu-lines span:first-child {
		transform: translateY(4px);
	}
	.motion-menu-lines span:last-child {
		transform: translateY(-4px);
	}
	.motion-menu-toggle.open .motion-menu-lines span:first-child {
		transform: rotate(45deg);
	}
	.motion-menu-toggle.open .motion-menu-lines span:last-child {
		transform: rotate(-45deg);
	}
