<script lang="ts">
	...
	const ogImage = $derived(
		article.coverImageSrc.startsWith('http')
			? article.coverImageSrc
			: `${baseUrl}${article.coverImageSrc}`
	);
	...
	<header class="article-hero">
		...
		<div class="article-shell article-hero-shell">
			...
			<p class="article-meta">
				Por Moisés Valero · {formatArticleDate(article.publishedAt)} · {article.readingMinutes} min de
				lectura
			</p>
			...
			<div class="share-card">
				...
				<div class="share-actions">
					<button
						...
						onclick={() => openShare(twitterShareHref)}
					>
						<svg viewBox="0 0 24 24" aria-hidden="true">
							<path
								d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.66l-5.22-6.82-5.97 6.82H1.66l7.73-8.84L1.23 2.25h6.83l4.72 6.24 5.46-6.24Zm-1.16 17.52h1.83L7.06 4.13H5.09l11.99 15.64Z"
							/>
						</svg>
					</button>
					<button
						...
						onclick={() => openShare(linkedinShareHref)}
					>
						<svg viewBox="0 0 24 24" aria-hidden="true">
							<path
								d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S.02 4.88.02 3.5 1.14 1 2.5 1s2.48 1.12 2.48 2.5ZM.37 8.02h4.26V23H.37V8.02Zm7.37 0h4.08v2.05h.06c.57-1.08 1.96-2.22 4.03-2.22 4.31 0 5.11 2.84 5.11 6.53V23h-4.25v-7.64c0-1.82-.03-4.17-2.54-4.17-2.55 0-2.94 1.99-2.94 4.04V23H7.74V8.02Z"
							/>
						</svg>
					</button>
					<button
					...
					>
						{#if copied}
							<svg viewBox="0 0 24 24" aria-hidden="true">
								<path
									d="m9.55 17.62-5.08-5.08 1.41-1.42 3.67 3.67 8.57-8.57 1.41 1.42-9.98 9.98Z"
								/>
							</svg>
						{:else}
							<svg viewBox="0 0 24 24" aria-hidden="true">
								<path
									d="M9 7a5 5 0 0 1 5-5h3a5 5 0 0 1 0 10h-2v-2h2a3 3 0 1 0 0-6h-3a3 3 0 0 0-3 3H9Zm-2 5h10v-2H7v2Zm-5 5a5 5 0 0 1 5-5h2v2H7a3 3 0 1 0 0 6h3a3 3 0 0 0 3-3h2a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5Z"
								/>
							</svg>
						{/if}
					</button>
