...
{#if open}
	<div class="career-backdrop" role="presentation" onmousedown={onBackdropMouseDown}>
		<div
			bind:this={panelEl}
			class="career-panel"
			role="dialog"
		...
		>
			...
			<div class="career-scroll">
				...
				<section
					class="career-feature-stage career-reveal career-reveal--visible"
					aria-labelledby="career-exp"
				>
...
<style>
	...
	.career-feature-preview {
		...
		border-radius: 8px;
		background:
			radial-gradient(circle at 18% 0%, rgba(0, 113, 227, 0.08), transparent 18rem), #ffffff;
		box-shadow:
	...
	:global(html.dark) .career-feature-preview {
		background:
			radial-gradient(circle at 18% 0%, rgba(77, 163, 255, 0.14), transparent 18rem), #0e141f;
	}
